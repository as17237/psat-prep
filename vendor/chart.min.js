/*!
 * vendor/chart.min.js — self-hosted Chart.js (WI-12, CLAUDE.md requires no
 * unpinned third-party CDN scripts in the deployed app).
 *
 * Version   : 4.5.1
 * Source    : https://cdn.jsdelivr.net/npm/chart.js@4.5.1/dist/chart.umd.min.js
 * Fetched   : 2026-08-30
 * SHA-256 of the unmodified upstream file (before this header comment was
 * prepended): 48444a82d4edcb5bec0f1965faacdde18d9c17db3063d042abada2f705c9f54a
 * License   : MIT (c) Chart.js Contributors — https://www.chartjs.org
 *
 * Reason this exact build: index.html currently loads
 * https://cdn.jsdelivr.net/npm/chart.js (unpinned "latest"); that URL resolved
 * to v4.5.1 (x-jsd-version: 4.5.1) at fetch time, so this is a pin of what the
 * app was actually already running, not an upgrade or downgrade.
 * This is the UMD build (defines the global `Chart`), matching the global
 * usage pattern (`new Chart(...)`) already present in the pages' chart code.
 * WI-12 does not rewire any page to load this file — that lands in WI-13/14.
 */
/*!
 * Chart.js v4.5.1
