...
export class SmartRoutingMapProvider {
     ...
     * @hidden
     */
    async getOverlappingRanges(collectionLink, sortedRanges, diagnosticNode, forceRefresh = false) {
        ...
        const collectionRoutingMap = await this.partitionKeyRangeCache.onCollectionRoutingMap(collectionLink, diagnosticNode, forceRefresh);
        let index = 0;
