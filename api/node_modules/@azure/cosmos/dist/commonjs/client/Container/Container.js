...
class Container {
  ...
  async semanticRerank(rerankContext, documents, options) {
    return (0, import_diagnostics.withDiagnostics)(
      (diagnosticNode) => this.clientContext.semanticRerank(rerankContext, documents, options, diagnosticNode),
      this.clientContext
    );
  }
  /**
