...
var import_InferenceService = require("./inference/InferenceService.js");
...
class ClientContext {
   ...
   * @hidden
   */
  async semanticRerank(rerankContext, documents, options, diagnosticNode) {
   ...
   * @internal
   */
  getOrCreateInferenceService() {
    this.inferenceService ??= new import_InferenceService.InferenceService(this.cosmosClientOptions);
