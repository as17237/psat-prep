...
class QueryIterator {
   ...
   */
  shouldForceQueryPlan() {
    if (this.resourceType !== import_common.ResourceType.item) {
      return false;
    }
    if (this.options.forceQueryPlan === true) {
      return true;
    }
    if (this.options.partitionKey !== void 0) {
      return false;
    }
  ...
  async forceQueryPlanExecutionContext(diagnosticNode) {
