...
const HTML_PAGES = ['index.html', 'parent.html', 'mistakes.html', 'feedback.html'];
const JS_SOURCES = ['js/pages/student.js', 'js/pages/parent.js', 'js/pages/mistakes.js', 'js/pages/feedback.js'];
...
function decls(base) {
  ...
  const KW = { 'block':['display:block'],'inline-block':['display:inline-block'],'inline':['display:inline'],
    ...
    'outline-hidden':['outline:2px solid transparent','outline-offset:2px'],'outline-none':['outline:2px solid transparent','outline-offset:2px'],
